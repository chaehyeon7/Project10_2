...
public class ResultActivity2 extends AppCompatActivity {
    int[] imgVIds = {R.id.imgv_01, R.id.img02, R.id.imgv_03,R.id.imgv_04, R.id.img05, R.id.imgv_06, R.id.imgv_07, R.id.img08, R.id.imgv_09};
    ImageView[] imgv = new ImageView[imgVIds.length];
    ViewFlipper viewFlip;
    int[] imgSrcIds = {R.drawable.i01, R.drawable.i02,R.drawable.i03, R.drawable.i04, R.drawable.i05, R.drawable.06, R.drawable.i07, R.drawable.i08, R.drawable.i09 };
    int[] voteCount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnStop = findViewById(R.id.btn_start);
